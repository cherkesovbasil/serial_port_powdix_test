...
def sc(gui, auto=False):
    ...
    frame_for_engine_1 = LabelFrame(frame_for_engines, bg="gray10", text="Двигатель №1 | отсутств. |", fg="white")
    ...
    if auto:
        ...
        sample_changer_auto_script.start_check(gui)
    else:
